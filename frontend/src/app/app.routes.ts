...
export const routes: Routes = [
  { path: 'login', loadComponent: () => import('./features/auth/login/login.component').then(m => m.LoginComponent) },
  {
    ...
    children: [
      ...
      { path: 'attendance', canActivate: [roleGuard], data: { roles: ['ADMIN', 'FACULTY'] }, loadComponent: () => import('./features/attendance/attendance.component').then(m => m.AttendanceComponent) },
      { path: 'marks', canActivate: [roleGuard], data: { roles: ['ADMIN', 'FACULTY'] }, loadComponent: () => import('./features/marks/marks.component').then(m => m.MarksComponent) },
